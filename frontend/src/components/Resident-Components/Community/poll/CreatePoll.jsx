...
export default function CreatePollDialog({ isOpen, onOpenChange, onSubmit }) {
    ...
    return (
        <div>
            ...
            <Dialog open={isOpen} onOpenChange={onOpenChange}>
                <DialogContent className="w-[400px]">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            <div>
                                <Label htmlFor="polls" className="block text-sm font-medium">
                                    Polls <span className="text-red-500">*</span>
                                </Label>
                                <button
                                    type="button"
                                ...
                                >
                                    <span className="flex items-center">
                                        <img
                                            src="/src/assets/poll.svg"
                                            alt="Poll icon"
                                            className="w-4 h-4 mr-2"
                                        />
                                        {selectedPoll
                                            ? `${selectedPoll.charAt(0).toUpperCase() + selectedPoll.slice(1)} polls`
                                            : "Select Polls"}
                                    </span>
                                ...
                                {dropdownOpen && (
                                    ...
                                    >
                                        <li
                                            ...
                                            onClick={() => handlePollSelection("multichoice")}
                                        >
                                            <div className="flex">
                                                <img
                                                    src="/src/assets/poll1.svg"
                                                    alt="Poll icon"
                                        ...
                                        <li
                                            className="px-4 py-2 cursor-pointer hover:bg-gray-100"
                                            onClick={() => handlePollSelection("ranking")}
                                        >
                                            <div className="flex">
                                                <img
                                                    src="/src/assets/poll2.svg"
                                                    alt="Poll icon"
                                                    className="w-5 h-5 mr-2"
                                                />
                                                Ranking polls
                                        ...
                                        <li
                                            className="px-4 py-2 cursor-pointer hover:bg-gray-100"
                                            onClick={() => handlePollSelection("rating")}
                                        >
                                            <div className="flex">
                                                <img
                                                    src="/src/assets/poll3.svg"
                                                    alt="Poll icon"
                                                    className="w-5 h-5 mr-2"
                                                />
                                                Rating polls
                                        ...
                                        <li
                                            className="px-4 py-2 cursor-pointer hover:bg-gray-100"
                                            onClick={() => handlePollSelection("numeric")}
                                        >
                                            <div className="flex">
                                                <img
                                                    src="/src/assets/poll4.svg"
                                                    alt="Poll icon"
                                                    className="w-5 h-5 mr-2"
                                                />
                                                Numeric polls
                                        ...
                                        <li
                                            className="px-4 py-2 cursor-pointer hover:bg-gray-100"
                                            onClick={() => handlePollSelection("text")}
                                        >
                                            <div className="flex">
                                                <img
                                                    src="/src/assets/poll5.svg"
                                                    alt="Poll icon"
                                                    className="w-5 h-5 mr-2"
                                                />
                                                Text polls
            ...
            <Dialog open={isThirdDialogOpen} onOpenChange={setIsThirdDialogOpen}>
                <DialogContent className="w-[400px]">
                    ...
                    <form onSubmit={handleSubmit}>
                                    ...
                                    {optionsThird.map((optionThird, index) => (
                                        <div key={index} className="flex items-center mb-4">
                                            <input
                                                type="number"
                                                value={optionThird}
                                                onChange={(e) => handleOptionChangeThird(index, e.target.value)}
                                                className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                                                placeholder={`Option ${index + 1}`}
                                            ...
                                            <button
                                                ...
                                                onClick={() => handleRemoveOptionThird(index)}
                        ...
                        <DialogFooter className="mt-4">
                            <Button variant="outline" onClick={handleThirdDialogClose}>
                                Cancel
                            </Button>
                            <Button type="submit">Create</Button>
                        </DialogFooter>
            ...
            <Dialog open={isForthDialogOpen} onOpenChange={setIsForthDialogOpen}>
                <DialogContent className="w-[400px]">
                    <DialogHeader>
                        <DialogTitle>Create Polls</DialogTitle>
                    </DialogHeader>
                    <form onSubmit={handleSubmit}>
                                ...
                                <>
                                    ...
                                    <div className="relative">
                                        <label htmlFor="pollType" className="block text-sm font-medium">
                                            Polls<span className="text-[#E74C3C]">*</span>
                                        </label>
                                        <select
                                            id="pollType"
                                            value={pollType}
                        ...
                        <DialogFooter className="mt-4">
                            <Button variant="outline" onClick={handleForthDialogClose}>
                                Cancel
                            </Button>
                            <Button type="submit">Create</Button>
                        </DialogFooter>
            ...
            <Dialog open={isFiveDialogOpen} onOpenChange={setIsFiveDialogOpen}>
                <DialogContent className="w-[400px]">
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            {selectedPoll === "numeric" && (
                                <>
                                    ...
                                    <div className="mb-4 flex space-x-4">
                                        <div>
                                            <label htmlFor="minValues" className="block text-sm font-medium">
                                                Min Values<span className="text-[#E74C3C]">*</span>
                                            </label>
                                            <input
                                                type="text"
                                                id="minValues"
                                        ...
                                        <div>
                                            <label htmlFor="maxValues" className="block text-sm font-medium">
                                                Max Values<span className="text-[#E74C3C]">*</span>
                                            </label>
                                            <input
                                                type="text"
                                                id="maxValues"
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="decimalPlaces" className="block text-sm font-medium">
                                            Decimal Places<span className="text-[#E74C3C]">*</span>
                                        </label>
                                        <select
                                            id="decimalPlaces"
                                            value={decimalPlaces}
                        ...
                        <DialogFooter className="mt-4">
                            <Button variant="outline" onClick={handleFiveDialogClose}>
                                Cancel
                            </Button>
                            <Button type="submit">Create</Button>
                        </DialogFooter>
            ...
            <Dialog open={isSixDialogOpen} onOpenChange={setIsSixDialogOpen}>
                <DialogContent className="w-[400px]">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            {selectedPoll === "text" && (
                                <>
                                    ...
                                    <label htmlFor="pollType" className="block text-sm mt-4 font-medium">
                                        Answer<span className="text-[#E74C3C]">*</span>
                                    </label>
                                    <textarea
                                        rows="4"
                        ...
                        <DialogFooter className="mt-4 ">
                            <Button variant="outline" onClick={handleSixDialogClose}>
                                Cancel
                            </Button>
                            <Button type="submit" disabled={!answerText.trim()}>Create</Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
            </Dialog>
