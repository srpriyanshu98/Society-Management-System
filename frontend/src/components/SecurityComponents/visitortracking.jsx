    ...
    return (
        <Card className="flex-1 p-6 bg-white h-full overflow-auto rounded-2xl">
            <CardHeader className="flex flex-row justify-between items-center p-0 font-poppins mb-3">
                ...
                <Button className="flex items-center space-x-2" onClick={handleAddVisitors}>
                                ...
                                {isLoading ? (
                                    ...
                                    filteredVisitors.map((Visitor) => (
                                        <tr key={Visitor.id} className="border-b">
                                            ...
                                            <td className="p-3 text-gray-500">{Visitor.date}</td>
                                            ...
                                            <td className="p-3 text-gray-500">{Visitor.Time}</td>
                                        </tr>
                                    ))
                                ) : (
                                    <tr>
                                        <td colSpan="6" className="p-4 text-gray-500 text-center font-semibold font-poppins">
            ...
            <AddVisitorDetails isOpen={isDialogOpen} onClose={handleCloseDialog} onAddVisitor={handleAddVisitor} />
        </Card>
    );
}
