      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Tabs defaultValue="owner">
          <TabsList className="grid grid-cols-2 w-[400px]">
            <TabsTrigger value="owner" className="p-5 rounded-t-xl">Owner</TabsTrigger>
            <TabsTrigger value="tenant" className="p-5 rounded-t-xl">Tenant</TabsTrigger>
          </TabsList>
        ...
        <div className="justify-self-end mt-3">
          <Button variant="outline" className="mr-1">Cancel</Button>
