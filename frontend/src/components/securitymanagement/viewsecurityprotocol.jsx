    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-md rounded-xl">
				...
				<div className="mt-2">
					<p className="text-gray-700 font-semibold font-poppins">Title</p>
				...
				<div className="mt-2 flex space-x-4">
					<div className="flex flex-col">
						<p className="text-gray-700 font-semibold font-poppins">Date</p>
						<span className="pe-5 pb-2 mt-2 ">
							{log.date}
						</span>
					</div>
					<div className="flex flex-col">
						<p className="text-gray-700 font-semibold font-poppins">Time</p>
						<span className="pe-5 pb-2 mt-2 ">
							{log.Time}
						</span>
					</div>
