...
export default function EditProfile({ userRole }) {
	...
	// State to track whether the inputs are editable
					...
					<Card className="p-3 w-[991px] h-[526px] mt-3 transition-all duration-300 ease-in-out transform">
						<form onSubmit={handleSubmit} className="flex mt-10 ml-10">
							...
							<div className="grid grid-cols-2">
								{["firstName", "lastName", "phoneNumber", "email", "society", "country", "state", "city"].map(
									(field, index) => (
										<div key={field} className={index % 2 !== 0 ? "ml-5" : ""}>
											...
											<Input
												...
												disabled={!isEditing} // Disable inputs when not in editing mode
											/>
