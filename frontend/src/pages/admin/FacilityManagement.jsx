	...
	const handleSaveFacility = async (facilityData) => {
		try {
			const formattedFacilityData = {
				...facilityData,
				scheduleServiceDate: moment(facilityData.serviceDate).format("YYYY-MM-DD"),
				remindBefore: typeof facilityData.remindBefore === "string"
			...
			if (editingFacility) {
				...
				const response = await axiosInstance.put(`/facilities/${editingFacility.id}`, formattedFacilityData);
				console.log("Update response:", response.data);
			} else {
				console.log("Creating new facility");
				const response = await axiosInstance.post("/facilities", formattedFacilityData);
