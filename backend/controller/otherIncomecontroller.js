...
export const addOtherIncome = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({ message: "Other income added successfully", otherIncome });
  } catch (error) {
    res
      .status(400)
      .json({ message: "Error adding other income", error: error.message });
  }
};
...
export const updateOtherIncome = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Other income updated successfully", otherIncome });
  } catch (error) {
    res
      .status(400)
      .json({ message: "Error updating other income", error: error.message });
  }
};
